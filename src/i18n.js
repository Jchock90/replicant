  ...
  resources: {
    en: {
      translation: {
        ...
        "about_bio": "Replicant is an electronic music project by Jesús Mansilla, active since 2016 from Paraná, Entre Ríos, Argentina. Its sound — dark, experimental, and deeply rooted in digital aesthetics — is built on repurposed video game hardware like the Nintendo Game Boy and PSP, combined with modern digital audio production tools such as trackers, synthesizers and DAWs. The project has been part of the chiptune and demoscene circuit, performing at events like Blip Blop Party and Flash Party, among others.",
        "Prensa": "Press",
        "Podcast": "Podcast",
        "Remix": "Remix",
        "Canal": "Channel",
    ...
    es: {
      translation: {
        ...
        "about_bio": "Replicant es un proyecto de música electrónica de Jesús Mansilla, activo desde 2016 con base en Paraná, Entre Ríos. Su sonido — oscuro, experimental y de marcada estética digital — se construye sobre hardware de consolas de videojuegos reutilizado, como la Nintendo Game Boy y PSP, combinado con herramientas modernas de producción de audio digital como trackers, sintetizadores y DAWs. El proyecto forma parte del circuito chiptune y demoscene, habiendo participado en eventos como las Blip Blop Party, Flash Party, entre otros.",
        "Prensa": "Prensa",
        "Podcast": "Podcast",
        "Remix": "Remix",
        "Canal": "Canal",
